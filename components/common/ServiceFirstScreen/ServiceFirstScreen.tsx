...
export const ServiceFirstScreen: FC<ServiceFirstScreen> = ({title, text, image, color, isShort}) => {
    ...
    return (
        ...
        :
        <div className={`${cls.firstSceen} ${cls.firstSceen_short}`}>
            <div className={`${cls.container} ${cls.container_short}`}>
                <div className={cls.content}>
                    <div className={cls.line} style={{background: color}}></div>
                    <h1 className={cls.title}>{title}</h1>
                    <p className={cls.text}>{text}</p>
